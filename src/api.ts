...
export const getMe = () => instance.get(`users/me`).then((r) => r.data);
...
export const getAmenities = () =>
  instance.get(`rooms/amenities`).then((r) => r.data);
...
export const checkBooking = ({
  ...
  if (dates) {
    ...
    return instance
      .get(
        `rooms/${room_pk}/bookings/check?check_in=${checkIn}&check_out=${checkOut}`
      )
      .then((response) => response.data);
  }
};
